...
namespace CrystalLib.Toolset.Dialogs
{
    ...
    public partial class TaskDialog : Component, IWin32Window
    {
        ...
        ///   with <see cref="TaskDialog.ButtonStyle"/> set to <see cref="CrystalLib.Toolset.Dialogs.TaskDialogButtonStyle.CommandLinks"/>
        ///   or <see cref="CrystalLib.Toolset.Dialogs.TaskDialogButtonStyle.CommandLinksNoIcon"/>, you delineate the command from the 
        ...
        /// </summary>
        /// <value>
        /// A <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle"/> that indicates the type of progress bar shown on the task dialog.
        /// </value>
        /// <remarks>
        /// <para>
        ///   If this property is set to <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.MarqueeProgressBar"/>, the marquee will
        ///   scroll as long as the dialog is visible.
        /// </para>
        /// <para>
        ///   If this property is set to <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.ProgressBar"/>, the value of the
        ...
        /// <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.MarqueeProgressBar"/>.
        /// </remarks>
        ...
        /// <remarks>
        /// This property is only used if the <see cref="ProgressBarStyle"/> property is 
        /// <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.ProgressBar"/>.
        /// </remarks>
        ...
        /// </summary>
        /// <value>
        /// A <see cref="CrystalLib.Toolset.Dialogs.ProgressBarState"/> indicating the state of the task dialog's progress bar.
        /// The default value is <see cref="CrystalLib.Toolset.Dialogs.ProgressBarState.Normal"/>.
        /// </value>
        /// <remarks>
        /// This property is only used if the <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle"/> property is 
        /// <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.ProgressBar"/>.
        /// </remarks>
        ...
        /// <summary>
        /// This method is for internal CrystalLib.Toolset.Dialogs use and should not be called from your code.
        /// </summary>
