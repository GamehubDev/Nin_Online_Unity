...
namespace CrystalLib.Toolset.Dialogs
{
    ...
    public class TaskDialogButton : TaskDialogItem
    {
        ...
        /// </summary>
        /// <value>
        /// One of the <see cref="CrystalLib.Toolset.Dialogs.ButtonType"/> values that indicates the type of the button. The default value
        /// is <see cref="CrystalLib.Toolset.Dialogs.ButtonType.Custom"/>.
        /// </value>
        ...
        ///   is <see cref="CrystalLib.Toolset.Dialogs.ButtonType.Custom"/>. For other button types, it is ignored.
        /// </para>
        /// <para>
