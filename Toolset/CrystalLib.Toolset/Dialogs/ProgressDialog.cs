    ...
    public partial class ProgressDialog : Component
    {
        ...
        public ProgressDialog(IContainer container)
        {
            ...
            if( !NativeMethods.IsWindowsVistaOrLater )
                Animation = AnimationResource.GetShellAnimation(CrystalLib.Toolset.Dialogs.ShellAnimation.FlyingPapers);
        }
        ...
        /// </summary>
        /// <value>
        /// One of the values of <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle"/>. 
        /// The default value is <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.ProgressBar"/>.
        /// </value>
        /// <remarks>
        /// <note>
        ...
        ///   progress bar will be hidden completely if this property is <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.MarqueeProgressBar"/>.
        /// </note>
        /// <para>
        ///   When this property is set to <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.ProgressBar" />, use the <see cref="ReportProgress(int)"/> method to set
        ///   the value of the progress bar. When this property is set to <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.MarqueeProgressBar"/>
        ...
        /// </para>
        /// <para>
        ///   This method has no effect is <see cref="ProgressBarStyle"/> is <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.MarqueeProgressBar"/>
        ///   or <see cref="CrystalLib.Toolset.Dialogs.ProgressBarStyle.None"/>.
        /// </para>
        /// </remarks>
        ...
        private void RunProgressDialog(IntPtr owner, object argument)
        {
            ...
            Interop.ProgressDialogFlags flags = CrystalLib.Toolset.Dialogs.Interop.ProgressDialogFlags.Normal;
            if( owner != IntPtr.Zero )
                flags |= CrystalLib.Toolset.Dialogs.Interop.ProgressDialogFlags.Modal;
            switch( ProgressBarStyle )
            {
            case ProgressBarStyle.None:
                flags |= CrystalLib.Toolset.Dialogs.Interop.ProgressDialogFlags.NoProgressBar;
                break;
            case ProgressBarStyle.MarqueeProgressBar:
                if( NativeMethods.IsWindowsVistaOrLater )
                    flags |= CrystalLib.Toolset.Dialogs.Interop.ProgressDialogFlags.MarqueeProgress;
                else
                    flags |= CrystalLib.Toolset.Dialogs.Interop.ProgressDialogFlags.NoProgressBar; // Older than Vista doesn't support marquee.
                break;
            }
            if( ShowTimeRemaining )
                flags |= CrystalLib.Toolset.Dialogs.Interop.ProgressDialogFlags.AutoTime;
            if( !ShowCancelButton )
                flags |= CrystalLib.Toolset.Dialogs.Interop.ProgressDialogFlags.NoCancel;
            if( !MinimizeBox )
                flags |= CrystalLib.Toolset.Dialogs.Interop.ProgressDialogFlags.NoMinimize;
