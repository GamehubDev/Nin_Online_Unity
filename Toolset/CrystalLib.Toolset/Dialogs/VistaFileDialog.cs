...
using CrystalLib.Toolset.Dialogs.Interop;
...
namespace CrystalLib.Toolset.Dialogs
{
    ...
    public abstract class VistaFileDialog : CommonDialog
    {
        ...
        internal abstract CrystalLib.Toolset.Dialogs.Interop.IFileDialog CreateFileDialog();
        ...
        private bool RunFileDialog(IntPtr hwndOwner)
        {
            ...
            CrystalLib.Toolset.Dialogs.Interop.IFileDialog dialog = null;
            try
            {
