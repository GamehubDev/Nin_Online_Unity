    ...
    internal class VS2012LightDockPaneStrip : DockPaneStripBase
    {
        ...
        private int GetMaxTabWidth_Document(int index)
        {
            ...
            if (DockPane.DockPanel.ShowDocumentIcon)
                width = sizeText.Width; //width = sizeText.Width + DocumentIconWidth + DocumentIconGapLeft + DocumentIconGapRight + DocumentTextGapRight;
            else
                width = sizeText.Width; //width = sizeText.Width + DocumentIconGapLeft + DocumentTextGapRight;
        ...
        private void WindowList_Click(object sender, EventArgs e)
        {
            ...
            foreach (TabVS2012Light tab in Tabs)
            {
                ...
                ToolStripItem item = SelectMenu.Items.Add(content.DockHandler.TabText, image);
